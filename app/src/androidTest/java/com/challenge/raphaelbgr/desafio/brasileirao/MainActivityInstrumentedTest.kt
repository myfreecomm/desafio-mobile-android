...
import com.challenge.raphaelbgr.desafio.brasileirao.base.util.TestUtilInstrumented
import com.challenge.raphaelbgr.desafio.brasileirao.di.TestApplicationModule
import com.challenge.raphaelbgr.desafio.brasileirao.di.TestDataModule
...
class MainActivityInstrumentedTest {
    ...
    fun loadApiMatchListDataCheck() {
        ...
        onView(withText(containsString("05/02/20"))).check(
            matches(isDisplayed())
        )
    }
