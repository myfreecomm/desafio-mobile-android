package com.challenge.raphaelbgr.desafio.brasileirao.matchdetails
...
import com.challenge.raphaelbgr.desafio.brasileirao.util.BrasileiraoUtil
...
class MatchDetailsActivity : BaseActivity() {
    ...
    private fun populateData() {
        ...
        bt_highlights.setOnClickListener { navigatorUtil.navigateToMatchHighlights(match!!) }
    }
